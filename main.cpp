...
// =============================================================
//  ALGORITHM IMPLEMENTATIONS (Course Requirement - CSE422)
// =============================================================

// ── Lab 4: DDA Line Drawing Algorithm ────────────────────────
//  Used to draw the railroad track tie/sleeper lines
...
// ── Lab 5: Bresenham's Line Drawing Algorithm ─────────────────
//  Used to draw the two main railway rails
...
// ── Lab 6: Mid-Point Circle Drawing Algorithm ─────────────────
//  Used to draw the clock face rim and train wheel rims
...
// =============================================================
//  CLOCK TOWER
//  Clock face rim → drawn with Mid-Point Circle Algorithm (Lab 6)
// =============================================================
void drawClockTower(){
    float nf=getNightFactor();
    ...
    // Clock face fill (standard drawCircle) then rim via Midpoint Circle Algorithm
    glColor3f(0.78f,0.78f,0.78f); drawCircle(bx+44,by+125,34,34);
    glColor3f(0.15f,0.15f,0.15f);
    glPointSize(3.0f);
    midpointCircle((int)(bx+44),(int)(by+125),34);   // ← Mid-Point Circle Algorithm
    midpointCircle((int)(bx+44),(int)(by+125),33);   // double stroke for thickness
    glPointSize(1.0f);
...
// =============================================================
//  RAILROAD TRACKS
//  Sleeper ties  → drawn with DDA Line Algorithm (Lab 4)
//  Rail beams    → drawn with Bresenham's Line Algorithm (Lab 5)
// =============================================================
void drawTracks(){
    // ── Wooden sleepers (ties) — DDA algorithm ────────────────
    glColor3f(0.42f,0.24f,0.08f);
    glPointSize(14.0f);          // thick point = wide sleeper
    for(int x = 0; x < 1200; x += 38){
        ddaLine(x, 243, x+28, 257);   // diagonal DDA stroke per sleeper
    }
    glPointSize(1.0f);

    // ── Two steel rails — Bresenham algorithm ─────────────────
    glColor3f(0.55f,0.18f,0.10f);
    glPointSize(9.0f);
    bresenhamLine(0, 261, 1199, 261);   // upper rail
    bresenhamLine(0, 272, 1199, 272);   // lower rail
    glPointSize(1.0f);
}
